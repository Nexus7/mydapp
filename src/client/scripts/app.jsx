...
import {GitHubHintABI, removeSigningPrefix} from 'oo7-parity';
import {Api} from '@parity/parity.js';

// const CounterCodeHash = '0x3cef768d94c2eaf8cfbf812aeccf5270256ef450b5697e83ddd702e0d19e8004';
...
export class App extends React.Component {
	constructor () {
		// console.log(bonds.code('0xe3536B95E877001f38324b0Ea164a0e37257f1d0').map(Api.util.sha3).then(console.log));
		super();
		this.addr = new Bond;
		this.addr.then(v => {
		...
		return (<div>
			{!!this.state.counter
				...
				: <div>
						...
						<InputBond bond={this.addr} validator={v => v.startsWith('0x') && v.length == 42 && bonds.code(v).map(_ => parity.api.util.sha3(_) == CounterCodeHash) ? v : null}/>				</div>
			}
		</div>);
	}
}